 ...
 */
 ...
 if(!isset($_pagi_propagar)){
	...
	$_pagi_propagar = array_keys($_POST);
...
if (!$_pagi_htaccess){
	 ...
	 */
	 ...
	 if ($_pagi_actual != 1){
		...
		$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." onclick='".$accion_paginador."(".$variables_a_propagar."".($_pagi_actual - 1)."); ".$accion_carrito."' href='#'>$_pagi_nav_anterior</a>";
	 }
	 ...
	 for ($_pagi_i = $_pagi_nav_desde; $_pagi_i<=$_pagi_nav_hasta; $_pagi_i++){//Desde p�gina 1 hasta �ltima p�gina ($_pagi_totalPags)
		if ($_pagi_i == $_pagi_actual) {
			...
			$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." onclick='".$accion_paginador."(".$variables_a_propagar."".$_pagi_i."); ".$accion_carrito."' href='#'>".$_pagi_i."</a>";
		}
	 }
	 ...
	 if ($_pagi_actual < $_pagi_totalPags){
		...
		$_pagi_url = $_pagi_actual + 1; //ser� el n�mero de p�gina al que enlazamos
		$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." onclick='".$accion_paginador."(".$variables_a_propagar."".($_pagi_actual + 1)."); ".$accion_carrito."' href='#'>$_pagi_nav_siguiente</a>";
	 }
 ...
 */
 ...
 $_pagi_info = " <span class=fuente8><b>Se muestran desde el $_pagi_desde hasta el $_pagi_hasta de un total de $_pagi_totalReg resultados</b></span>";
