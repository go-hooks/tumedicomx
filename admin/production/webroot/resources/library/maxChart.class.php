...
class maxChart {
   ...
   function drawVertical(){
      ...
      foreach ($this->data as $key=>$value) {
         ...
         echo '  <div class="barv">'."\r\n";
         echo '    <div class="barvvalue" style="margin-top:'.$b.'px; width:'.$barw.'px;">'.number_format($value, 0, '', ',').'</div>'."\r\n";
	     echo '    <div><img src="'.URL_IMAGES.'bar'.$color.'.png" style="width:'.$barw.'px; height:'.$a.'px;" /></div>'."\r\n";
         echo '    <div class="barvvalue" style="width:'.$barw.'px;">'.str_replace('_', ' ',$key).'</div>'."\r\n";
         echo '  </div>'."\r\n";
   ...
   function drawHorizontal(){
      ...
      foreach ($this->data as $key=>$value) {
         ...
         echo '    <div class="barhimage"><img src="'.URL_IMAGES.'barh'.$color.'.png" style="width:'.$b.'px; height:'.$barh.'px;" /></div>'."\r\n";
