...
$db = "upaleco_newupale"; // your MySQL database name
$mysql_username = "upaleco_nzuoper";  // your MySQL username
$mysql_password = "jK1s@>t>ScZr";  // your MySQL password

/*
$from_emailaddress = "omar@sustam.com";// your email address to show who the email is from (should be different $to_emailaddress)
$to_emailaddress = "omar@sustam.com"; // your email address to send backup files to
...
//$time_internal=2;// 2 = seconds - only allow backup to run once each 2 seconds
...
/*
$ftp_username ="upaleco"; // your ftp username
$ftp_password ="u20081115eup/nov."; // your ftp password
$ftp_server ="ftp.upale.com.mx"; // eg. ftp.yourdomainname.com
...
// Regresar a la pagina desde donde se llamo al script
