<div class="row">
    <form enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo url_format('catalogosProveedores/aplicar') ?>" method="post">
        <div class="col-sm-6">
        ...
        <div class="col-sm-5">               
            ...
            <?php if (hasPermission('acceso_catalogos_proveedores')): ?>
                <button type="submit" class="btn btn-success  btn-sm">
                    <span class="glyphicon glyphicon-ok"></span> 
                    Aplicar
                </button>
                <a href="<?php echo url_format('catalogosProveedores', $buscar) ?>" class="btn btn-danger  btn-sm">
