<div class="row">
    <form enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo url_format('laboratorios/agregarAseguradora') ?>" method="post">
        <div class="col-sm-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php if (isset($laboratorio['id'])): ?>
                        <input type="hidden" name="registro_id" value="<?php echo $laboratorio['id'] ?>">
                    <?php endif; ?>
                   ...
                   <?php foreach ($laboratorio_aseguradoras as $aseguradoras): ?> 
                           <tr>
                           ...
                           <td>    
                            ...
                            <td>        
                                <a class="btn btn-danger btn-xs" title="Borrar" 
                                        href="<?php echo url_format('laboratorios/deleteAseguradora', array('aseguradora_id' => $aseguradoras['id'],'registro_id' => $laboratorio['id'], 'p' => $buscar['p'])); ?>">
    ...
    <form enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo url_format('laboratorios/agregarTarjeta') ?>" method="post">
        <div class="col-sm-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                   ...
                   <?php foreach ($laboratorio_tarjetas as $tarjetas): ?> 
                           <tr>
                           ...
                           <td>    
                            ...
                            <td>        
                                <a class="btn btn-danger btn-xs" title="Borrar" 
                                        href="<?php echo url_format('laboratorios/deleteTarjeta', array('tarjeta_id' => $tarjetas['id'],'registro_id' => $laboratorio['id'], 'p' => $buscar['p'])); ?>">
                                        <span class="glyphicon glyphicon-remove"></span> Borrar
                                </a>
                            </td>
