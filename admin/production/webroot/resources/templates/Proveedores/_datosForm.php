<div class="row">
    <form enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo url_format('proveedores/agregarAseguradora') ?>" method="post">
        <div class="col-sm-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php if (isset($proveedor['id'])): ?>
                        <input type="hidden" name="registro_id" value="<?php echo $proveedor['id'] ?>">
                    <?php endif; ?>
                   ...
                   <?php foreach ($proveedor_aseguradoras as $aseguradoras): ?> 
                           <tr>
                           ...
                           <td>    
                            ...
                            <td>        
                                <a class="btn btn-danger btn-xs" title="Borrar" 
                                        href="<?php echo url_format('proveedores/deleteAseguradora', array('aseguradora_id' => $aseguradoras['id'],'registro_id' => $proveedor['id'], 'p' => $buscar['p'])); ?>">
    ...
    <form enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo url_format('proveedores/agregarTarjeta') ?>" method="post">
        <div class="col-sm-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                   ...
                   <?php foreach ($proveedor_tarjetas as $tarjetas): ?> 
                           <tr>
                           ...
                           <td>    
                            ...
                            <td>        
                                <a class="btn btn-danger btn-xs" title="Borrar" 
                                        href="<?php echo url_format('proveedores/deleteTarjeta', array('tarjeta_id' => $tarjetas['id'],'registro_id' => $proveedor['id'], 'p' => $buscar['p'])); ?>">
                                        <span class="glyphicon glyphicon-remove"></span> Borrar
                                </a>
                            </td>
