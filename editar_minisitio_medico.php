...
<section class="wrapper">
        ...
        <h2>MI PERFIL<br>            
            ...
            <?php
                ...
                if(isset($_GET['error']))
                {
                    ...
                    if($_GET['error']==1) echo 'Debe aceptar los términos y condiciones.';
                    if($_GET['error']==2) echo 'El correo no es válido.';
                    ...
                    if($_GET['error']==6) echo 'Debe seleccionar el género del médico.';
    ...
    <div class="registro">
        ...
        <table width="850" height="220">
            ...
            <tr>
                <!--<td>RADIO <input class="txt txt2" type="text" name="radio" value="<?php echo @$medico['radio_contacto'] ?>"></td>-->
                <td>HORARIO <input class="txt txt2" type="text" name="horario" value="<?php echo @$medico['horario'] ?>"></td>
            </tr>
        </table>
        <div class="clear"></div>
    </div>
    ...
    <div class="registro">
        ...
        <p>RAZON SOCIAL <input class="txt" type="text" name="razon_social" value="<?php echo @$medico['razon_social'] ?>"></p>
        <p>RFC.<input class="txt" class="txt" type="text" name="rfc" value="<?php echo @$medico['rfc'] ?>"></p>

        <table width="850" height="130">
            <tr>
                <td>CALLE <input class="txt txt3" type="text" name="calle_facturacion" value="<?php echo @$medico['calle_facturacion'] ?>"></td>
                <td width="210">NUM <input class="txt txt1" class="txt" type="text" name="numero_facturacion" value="<?php echo @$medico['numero_facturacion'] ?>"></td>
            </tr>
            <tr>
                <td>COLONIA <input class="txt txt3" type="text" name="colonia_facturacion" value="<?php echo @$medico['colonia_facturacion'] ?>"></td>
                <td>CP <input class="txt txt1" type="text" name="cp_facturacion" value="<?php echo @$medico['cp_facturacion'] ?>"></td>
            </tr>
        </table>
    ...
    <div class="datosminisitio registro">
        ...
        <table width="850" height="250">
            ...
            <tr>
                <td>URL</td>
                <td><input class="txt" class="txt" type="text" name="url" placeholder="URL" value="<?php echo @$medico['url'] ?>"></td>
            </tr>
            
            <tr>
                <td valign="top">DESCRIPCIÓN</td>
                <td><textarea name="descripcion" class="txtarea"><?php echo @$medico['descripcion'] ?>"</textarea></td>
            </tr>
            <tr>
                <td>REDES SOCIALES </td>
                <td><img src="img/ico-faceregistro.jpg"><input type="text" class="txt txt1" name="facebook" placeholder="URL" value="<?php echo @$medico['facebook'] ?>">
                    <img src="img/ico-twitterregistro.jpg"><input type="text" class="txt txt1" name="twitter" placeholder="URL" value="<?php echo @$medico['twitter'] ?>">
                    <img src="img/ico-skype.jpg"><input type="text" class="txt txt1" name="skype" placeholder="URL" value="<?php echo @$medico['skype'] ?>">
                </td>
            </tr>
            <tr>
                <td>SITIO WEB</td>
                <td><input class="txt" class="txt" type="text" name="sitio_web" value="<?php echo @$medico['sitio_web'] ?>" placeholder="URL"></td>
            </tr> 

            <tr>
                <td>UBICACIÓN DEL MAPA</td>
                <td><input class="txt" class="txt" type="text" name="mapa" value="<?php echo @$medico['mapa'] ?>"></td>
            </tr> 
