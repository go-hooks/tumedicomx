...
<section class="wrapper">
    ...
    <div class="registro">
        <h2>REGISTRO GRATUITO HOSPITAL Y CLINICA<br>
        ...
        <table width="850" height="110">
            <tr>
                <td width="450">CATEGORIA*
                    <select required=""  class="txt txt2" name="categoria_id" id="categoria_id" onchange="hospitales(this.value)">                                                    
                ...
                <td>SUBCATEGORIA*
                    ...
                    <select required="" class="txt txt2" name="subcategoria_id" id="subcategoria_id">                                                                            
