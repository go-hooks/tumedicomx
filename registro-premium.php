...
<form enctype="multipart/form-data" class="clear" name="contacto"  method="post" action="envia_registro_premium.php" onsubmit="return validacion(correo_contacto,password,password2)">  
    ...
    <div class="registro">
        ...
        <p class="radios">
            <input type="radio" name="genero" value="DR" checked="">DR. 
            <input type="radio" name="genero" value="DRA">DRA.
            <input type="radio" name="genero" value="LIC">LIC.
        </p>
        <p>NOMBRE* <input required="" class="txt" type="text" name="nombre"></p>
        <p>APELLIDOS* <input required="" class="txt" class="txt" type="text" name="apellidos"></p>
    ...
    <div class="registro">
        ...
        <table width="850" height="220">
            ...
            <tr>
                ...
                <td>TELÉFONO MOVIL <input class="txt txt2" type="text" name="movil"></td>
            </tr>
            <tr>
                <td>RADIO <input class="txt txt2" class="txt" type="text" name="radio"></td> 
                <td>HORARIO <input class="txt txt2" class="txt" type="text" name="horario"></td>   
            </tr>
        </table>
        <div class="clear"></div>
    </div>
    ...
    <div class="registro">
        ...
        <p>RAZON SOCIAL <input class="txt" type="text" name="razon_social"></p>
        <p>RFC.<input class="txt" class="txt" type="text" name="rfc"></p>

        <table width="850" height="130">
            <tr>
                <td>CALLE <input class="txt txt3" type="text" name="calle_facturacion"></td>
                <td width="210">NUM <input class="txt txt1" class="txt" type="text" name="numero_facturacion"></td>
            </tr>
            <tr>
                <td>COLONIA <input class="txt txt3" type="text" name="colonia_facturacion"></td>
                <td>CP <input class="txt txt1" type="text" name="cp_facturacion"></td>
            </tr>
        </table>
