...
<section class="wrapper">
    ...
    <div class="registro">
        <h2>REGISTRO GRATUITO MEDICO<br>
...
<form class="clear" name="contacto"  method="post" action="envia_registro.php" onsubmit="return validacion(correo_contacto,password,password2)"> 
    ...
    <table class="suscribir">
        <tr>
            <td><input required="" type="checkbox" class="radios" name="terminos" value="terminos"><a href="terminos.php" target="_blank">Acepto los terminos y condiciones</a></td>
            <td> 
