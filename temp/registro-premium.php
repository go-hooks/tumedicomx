...
<section class="wrapper">
    ...
    <div class="registro">
        <h2>REGISTRO PREMIUM<br>
            <span>Si deseas convertirte en Profesional Premium, llena el siguiente formulario y un asesor de venta se comunicará contigo a la brevedad</span></h2>
    </div>

    <div class="registro">
        <p class="subt">DATOS BASICOS</p>
        <p class="radios"><input type="radio" name="titulo">DR. <input type="radio" name="titulo">DRA.</p>
        <p>NOMBRE* <input class="txt" type="text" name="nombre"></p>
        <p>APELLIDOS* <input class="txt" class="txt" type="text" name="apellidos"></p>
    ...
    <div class="registro">
        ...
        <table width="850" height="220">
            ...
            <tr>
                ...
                <td>BIPER <input class="txt txt2" class="txt" type="text" name="biper"></td>
            </tr>
        </table>
        <div class="clear"></div>
    </div>
    ...
    <table class="suscribir">
        <tr>
            ...
            <td> 
                <input type="button" class="btnregistro fr" value="ENVIAR DATOS">
            </td>
        </tr>
    </table>
