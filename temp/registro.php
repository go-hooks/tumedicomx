...
<section class="wrapper">
    ...
    <table class="suscribir">
        <tr>
            <td><input type="radio" class="radios" name="terminos"><a href="terminos.php">Acepto los terminos y condiciones</a></td>
            <td> 
                <input type="button" class="btnregistro fr" value="SUSCRIBIR">
            </td>
        </tr>
    </table>
